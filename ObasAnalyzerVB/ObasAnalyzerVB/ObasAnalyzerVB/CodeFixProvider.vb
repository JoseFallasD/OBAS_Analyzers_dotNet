...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(ObasAnalyzerVBCodeFixProvider)), [Shared]>
Public Class ObasAnalyzerVBCodeFixProvider
    ...
    Public NotOverridable Overrides ReadOnly Property FixableDiagnosticIds As ImmutableArray(Of String)
        Get
            Return ImmutableArray.Create(ObasAnalyzerVBAnalyzer.DiagnosticId)
        End Get
    End Property
